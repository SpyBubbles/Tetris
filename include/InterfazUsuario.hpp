...
class InterfazUsuario: public sf::Drawable {
    ...
    void GameOver(); //Texto gam over 
    void NewScore(); //Tecto new score
...
void InterfazUsuario::GameOver(){   //Retornar 1 si es game over
    gameOver = 1;
}

void InterfazUsuario::NewScore(){   //Retornar 1 si es new score
    newScore = 1;
}
